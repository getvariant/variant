...
enum ParserErrorTemplate {
	...
	// View related errors
	NO_VIEWS_CLAUSE                    (ParserError.Severity.INFO, "VIEWS clause is not found"),                                              /// test exists.
	...
	WEIGHT_NOT_BOOLEAN                 (ParserError.Severity.ERROR, "'tests/experience/weight' property must be a number (Test [%s], Experience [%s])"),
	...
	VIEWREF_INVALID                    (ParserError.Severity.ERROR, "'tests/onViews/viewRef' property [%s] references an undefined view (Test [%s])"),
	...
	EXPERIENCEREF_PATH_NOT_STRING      (ParserError.Severity.ERROR, "'tests/onViews/variants/path' property must be a string (Test [%s], ViewRef [%s])"),
