 ...
 * getting posted of this flashpoint and informing the container whether this session is in fact qualified
...
public interface TestQualificationFlashpoint extends RuntimeFlashpoint {
	 ...
	 * will ignore the value set with this method, if this test was not disqualified. Coversely,
