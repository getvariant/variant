...
public class ParserSerialMetaErrorTest extends BaseTestCore {
	 ...
	 */
	@Test
	public void metaHooksNotListTest() throws Exception {
		...
		assertEquals(1, response.getMessages().size());
		ParserMessage error = response.getMessages().get(0);
		assertEquals(new ParserMessageImpl(ParserError.META_HOOKS_NOT_LIST, "namee").getText(), error.getText());
		assertEquals(Severity.ERROR, error.getSeverity());
	}

	/**
	 * META_HOOKS_NOT_OBJECT
	 * @throws Exception
	 */
	@Test
	public void metaHooksNotObjectTest() throws Exception {
		...
		ParserMessage error = response.getMessages().get(0);
		assertEquals(new ParserMessageImpl(ParserError.META_HOOKS_NOT_OBJECT).getText(), error.getText());
		assertEquals(Severity.ERROR, error.getSeverity());
		error = response.getMessages().get(1);
		assertEquals(new ParserMessageImpl(ParserError.META_HOOKS_NOT_OBJECT).getText(), error.getText());
		assertEquals(Severity.ERROR, error.getSeverity());
	...
	/**
	 * META_HOOK_UNSUPPORTED_PROPERTY, META_HOOK_CLASS_NAME_MISSING
	 * @throws Exception
	 */
	@Test
	public void metaHookNameMissingTest() throws Exception {
		...
		assertEquals(1, response.getMessages().size());
		ParserMessage error = response.getMessages().get(0);
		assertEquals(new ParserMessageImpl(ParserError.META_HOOK_NAME_MISSING).getText(), error.getText());
		assertEquals(Severity.ERROR, error.getSeverity());
	 ...
	 */
	@Test
	public void metaHookClassNameMissingTest() throws Exception {
		...
		assertEquals(2, response.getMessages().size());
		ParserMessage error = response.getMessages().get(0);
		assertEquals(new ParserMessageImpl(ParserError.META_HOOK_UNSUPPORTED_PROPERTY, "class-Name").getText(), error.getText());
		assertEquals(Severity.WARN, error.getSeverity());
		error = response.getMessages().get(1);
		assertEquals(new ParserMessageImpl(ParserError.META_HOOK_CLASS_NAME_MISSING, "bar").getText(), error.getText());
		assertEquals(Severity.ERROR, error.getSeverity());
	}

	/**
	 * META_HOOK_UNSUPPORTED_PROPERTY
	 * @throws Exception
	 */
	@Test
	public void metaUnsupportedPropertyTest() throws Exception {
		...
		assertEquals(1, response.getMessages().size());
		ParserMessage error = response.getMessages().get(0);
		assertEquals(new ParserMessageImpl(ParserError.META_HOOK_UNSUPPORTED_PROPERTY, "foo").getText(), error.getText());
		assertEquals(Severity.WARN, error.getSeverity());
	}
	 ...
	 */
	@Test
	public void metaHookNameDupeTest() throws Exception {
		...
		assertEquals(1, response.getMessages().size());
		ParserMessage error = response.getMessages().get(0);
		assertEquals(new ParserMessageImpl(ParserError.META_HOOK_NAME_DUPE, "bar").getText(), error.getText());
		assertEquals(Severity.ERROR, error.getSeverity());
	}
