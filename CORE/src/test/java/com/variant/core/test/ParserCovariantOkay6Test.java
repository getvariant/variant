...
public class ParserCovariantOkay6Test extends BaseTestCore {
	...
	public void test() throws Exception {
		...
		assertEquals(1, variant.getCovariantExperiences().size());
		assertEquals(test1.getExperience("B"), variant.getCovariantExperiences().get(0));
		assertEquals("/path/to/state2/test1.B+test3.B", variant.getParameter("path"));

		variant = variants.get(2);
		assertEquals(variant.getExperience(), test3.getExperience("B"));
		assertEquals(1, variant.getCovariantExperiences().size());
		assertEquals(test1.getExperience("C"), variant.getCovariantExperiences().get(0));
		assertEquals("/path/to/state2/test1.C+test3.B", variant.getParameter("path"));
		...
		variant = variants.get(5);
		assertEquals(variant.getExperience(), test3.getExperience("B"));
		assertEquals(2, variant.getCovariantExperiences().size());
		assertEquals(test1.getExperience("B"), variant.getCovariantExperiences().get(0));
		assertEquals(test2.getExperience("B"), variant.getCovariantExperiences().get(1));
		assertEquals("/path/to/state2/test1.B+test2.B+test3.B", variant.getParameter("path"));

		variant = variants.get(6);
		assertEquals(variant.getExperience(), test3.getExperience("B"));
		assertEquals(2, variant.getCovariantExperiences().size());
		assertEquals(test1.getExperience("B"), variant.getCovariantExperiences().get(0));
		assertEquals(test2.getExperience("C"), variant.getCovariantExperiences().get(1));
		assertEquals("/path/to/state2/test1.B+test2.C+test3.B", variant.getParameter("path"));
		...
		assertEquals(test1.getExperience("C"), variant.getCovariantExperiences().get(0));
		assertEquals(test2.getExperience("B"), variant.getCovariantExperiences().get(1));
		assertEquals("/path/to/state2/test1.C+test2.B+test3.B", variant.getParameter("path"));
		...
		assertEquals(test1.getExperience("C"), variant.getCovariantExperiences().get(0));
		assertEquals(test2.getExperience("C"), variant.getCovariantExperiences().get(1));
		assertEquals("/path/to/state2/test1.C+test2.C+test3.B", variant.getParameter("path"));
		...
		assertEquals(1, variant.getCovariantExperiences().size());
		assertEquals(test1.getExperience("B"), variant.getCovariantExperiences().get(0));
		assertEquals("/path/to/state2/test1.B+test3.C", variant.getParameter("path"));

		variant = variants.get(11);
		assertEquals(variant.getExperience(), test3.getExperience("C"));
		assertEquals(1, variant.getCovariantExperiences().size());
		assertEquals(test1.getExperience("C"), variant.getCovariantExperiences().get(0));
		assertEquals("/path/to/state2/test1.C+test3.C", variant.getParameter("path"));
		...
		assertEquals(test1.getExperience("B"), variant.getCovariantExperiences().get(0));
		assertEquals(test2.getExperience("B"), variant.getCovariantExperiences().get(1));
		assertEquals("/path/to/state2/test1.B+test2.B+test3.C", variant.getParameter("path"));
		...
		assertEquals(test1.getExperience("B"), variant.getCovariantExperiences().get(0));
		assertEquals(test2.getExperience("C"), variant.getCovariantExperiences().get(1));
		assertEquals("/path/to/state2/test1.B+test2.C+test3.C", variant.getParameter("path"));
		...
		assertEquals(test1.getExperience("C"), variant.getCovariantExperiences().get(0));
		assertEquals(test2.getExperience("B"), variant.getCovariantExperiences().get(1));
		assertEquals("/path/to/state2/test1.C+test2.B+test3.C", variant.getParameter("path"));
		...
		assertEquals(test1.getExperience("C"), variant.getCovariantExperiences().get(0));
		assertEquals(test2.getExperience("C"), variant.getCovariantExperiences().get(1));
		assertEquals("/path/to/state2/test1.C+test2.C+test3.C", variant.getParameter("path"));
