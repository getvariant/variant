...
public class EventWriterTest extends BaseTest {
	...
	public void customEventTest1() throws Exception {
		...
		VariantSession ssn2 = api.getSession("ssn2");
		VariantStateRequest request = api.dispatchRequest(ssn2, s2, targetingTrackerString("test2.C","test3.A","test4.A","test5.B","test6.C"));
	...
	public void customEventTest2() throws Exception {
		...
		api.addHookListener(new TestQualificationHookListenerDisqualifyTest(true, schema.getTest("test2")));
		api.addHookListener(new TestQualificationHookListenerDisqualifyTest(false, schema.getTest("test3")));
	...
	private static class TestQualificationHookListenerDisqualifyTest implements HookListener<TestQualificationHook> {
		...
		private TestQualificationHookListenerDisqualifyTest(boolean removeFromTt, com.variant.core.schema.Test...testsToDisqualify) {
