 ...
 * @author Igor
 */
public class ParserCovariantOkay5Test extends BaseTest {
	...
	public void test() throws Exception {
		...
		//assertEquals(VariantCollectionsUtils.list(test1, test3), VariantRuntime.getCovariantTests(test2));
		//assertEquals(VariantCollectionsUtils.list(test1, test2), VariantRuntime.getCovariantTests(test3));
		...
		assertEquals("/path/to/view2/test1.B+test2.B+test3.B", variant.getPath());
		...
		assertEquals("/path/to/view2/test1.B+test2.C+test3.B", variant.getPath());
		...
		assertEquals(test1.getExperience("C"), variant.getCovariantExperiences().get(0));
		assertEquals(test2.getExperience("B"), variant.getCovariantExperiences().get(1));
		assertEquals("/path/to/view2/test1.C+test2.B+test3.B", variant.getPath());
		...
		assertEquals(test1.getExperience("C"), variant.getCovariantExperiences().get(0));
		assertEquals(test2.getExperience("C"), variant.getCovariantExperiences().get(1));
		assertEquals("/path/to/view2/test1.C+test2.C+test3.B", variant.getPath());
		...
		assertEquals(test1.getExperience("B"), variant.getCovariantExperiences().get(0));
		assertEquals(test2.getExperience("B"), variant.getCovariantExperiences().get(1));
		assertEquals("/path/to/view2/test1.B+test2.B+test3.C", variant.getPath());
		...
		assertEquals(test1.getExperience("B"), variant.getCovariantExperiences().get(0));
		assertEquals(test2.getExperience("C"), variant.getCovariantExperiences().get(1));
		assertEquals("/path/to/view2/test1.B+test2.C+test3.C", variant.getPath());
		...
		assertEquals(test1.getExperience("C"), variant.getCovariantExperiences().get(0));
		assertEquals(test2.getExperience("B"), variant.getCovariantExperiences().get(1));
		assertEquals("/path/to/view2/test1.C+test2.B+test3.C", variant.getPath());
		...
		assertEquals(test1.getExperience("C"), variant.getCovariantExperiences().get(0));
		assertEquals(test2.getExperience("C"), variant.getCovariantExperiences().get(1));
		assertEquals("/path/to/view2/test1.C+test2.C+test3.C", variant.getPath());
