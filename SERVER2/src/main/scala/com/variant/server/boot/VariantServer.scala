 ...
 * @author Igor
 */
object VariantServer extends LazyLogging {
   ...
   private implicit val system: ActorSystem = ActorSystem("helloAkkaHttpServer")
   ...
   def schemata: Schemata = _schemaDeployer.schemata
