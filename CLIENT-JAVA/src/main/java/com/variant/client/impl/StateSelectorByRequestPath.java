...
public class StateSelectorByRequestPath  {
	...
	public static boolean match(String pattern, String string) {
		...
		if (!pattern.startsWith("/")) throw new InternalException("Pattern must start with [/] but was [" + pattern + "]");
		if (!string.startsWith("/")) throw new InternalException("String must start with [/] but was [" + string + "]");
